package com.foshizzle.shrinktube;
...
public class Constants {
    ...
    public interface ACTION {
        public static String PREV_ACTION = "com.foshizzle.ytube.action.prev";
        public static String PAUSE_PLAY_ACTION = "com.foshizzle.ytube.action.play";
        public static String NEXT_ACTION = "com.foshizzle.ytube.action.next";
        public static String STARTFOREGROUND_WEB_ACTION = "com.foshizzle.ytube.action.playingweb";
        public static String STOPFOREGROUND_WEB_ACTION = "com.foshizzle.ytube.action.stopplayingweb";
        public static String STARTFOREGROUND_YTUBE_ACTION = "com.foshizzle.ytube.action.playingytube";
        public static String STOPFOREGROUND_YTUBE_ACTION = "com.foshizzle.ytube.action.stopplayingytube";
    }
